...
import 'package:online_store/views/detail/screens/order_screen.dart';
...
class _AccountScreenState extends ConsumerState<AccountScreen> {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text("Do you really want to logout ?",style: GoogleFonts.montserrat(
            fontSize: 16,
  ...
  Widget build(BuildContext context) {
    ...
    ref.read(deliveredOrderCountProvider.notifier).fetchDeliverCount(buyerId, context);
